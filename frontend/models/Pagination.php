...
//        index.php?controller=&action=&page=3
    ...
    public function getPrevPage() {
        ...
        if ($current_page >= 2) {
            ...
            $page = $current_page - 1;
            $prev_url =
                "index.php?name=$str&filter=$filter&controller=$controller&action=$action&page=$page";
//            $prev_url =
        ...
        if ($this->params['full_mode'] == FALSE) {
            for ($page = 1; $page <= $total_page; $page++) {
                ...
                if ($page == 1 || $page == $total_page || $page  == $current_page - 1 || $page == $current_page + 1) {
                    $page_url = "index.php?name=$str&filter=$filter&controller=$controller&action=$action&page=$page";
