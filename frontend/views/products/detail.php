            ...
            <div class="col-lg-6 col-md-6">
                <div class="product-details-tab">
                    <div id="img-1" class="zoomWrapper single-zoom">
                        <a href="#">
                            <img id="zoom1" src="../backend/assets/uploads/<?php echo $product['avatar'] ?>" data-zoom-image="assets/img/product/productbig5.jpg" alt="big-1">
                        </a>
                    </div>
...
<!--                            <span class="old_price">$80.00</span>-->
                        ...
                        <div class="product_variant quantity">
                            ...
                            <button class="button" data-id="<?php echo $product['id']?>" type="submit">add to cart</button>
